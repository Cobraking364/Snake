# Snake
A simple game of Snake made in Java with JavaFX.
...
# Run
When running the jar file jar file you can specify game size as parameters. If parameters are invalid or missing an error is thrown.
